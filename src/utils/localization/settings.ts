...
export const locales = [fallbackLng, "en", "ja"] as const; // This is an array representing all the supported language codes, including the fallback language. It is defined here as [‘ko’, ‘en’].
