...
export const archivoMedium = localFont({
  ...
  display: "swap",
  weight: "45 920",
  variable: "--font-archivoMedium",
});

export const archivoSemibold = localFont({
  src: "./../assets/fonts/Archivo-SemiBold.ttf",
  display: "swap",
  weight: "45 920",
  variable: "--font-archivoSemibold",
  });

export const archivoBold = localFont({
