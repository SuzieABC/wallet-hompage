...
export default function IntroOne({
  ...
  const cards = [
    ...
    { img: card4, title: card_4_title, content: card_4_content },
  ];
  return (
    <div className="flex flex-col items-center w-full relative bg-[#F5F5F5]">
      ...
      <div className="w-full overflow-x-auto flex space-x-4 mb-[80px] px-[20px]">
        {cards.map((item) => (
          <div
            key={item.title}
            className="w-[87.5%] bg-[#E3E4E8] rounded-xl justify-start items-start gap-2.5 flex-shrink-0"
          >
            <div className="px-5 pt-5 bg-[#E3E4E8] rounded-2xl flex-col justify-start items-start gap-5 inline-flex">
